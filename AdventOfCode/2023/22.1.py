...
def solve1(input: str) -> str | int | None:
    ...
    for falling in list(sorted(bricks, key=lambda x: x.lowest)):
    ...
    return sum(brick.disintegrable for brick in bricks)


if __name__ == '__main__':
    aoc(day=22, part=1, solve1=solve1, example=False)
